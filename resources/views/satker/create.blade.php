...
@section('content')
  ...
  <div class="card card-custom gutter-b">
    <div class="card-body">
      <form action="{{ route('satker.store') }}" class="row" method="POST">
        @csrf
        <div class="col-md-12">
          <div class="card card-custom card-stretch gutter-b">
            <div class="card-header">
              <h3 class="card-title">Tambah Satuan Kerja</h3>
            </div>
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <x-validation.txt-stack type="text" id="sk_name" name="sk_name" placeholder="Nama Satuan Kerja"
                    value="{{ old('sk_name') }}" :messages="$errors->get('sk_name')">Nama Satuan Kerja
                    <x-redstar /></x-validation.txt-stack>

                  <x-validation.txt-stack type="text" id="sk_kode" name="sk_kode" placeholder="Kode Satuan Kerja"
                    value="{{ old('sk_kode') }}" :messages="$errors->get('sk_kode')">Kode Satuan Kerja
                    <x-redstar /></x-validation.txt-stack>
