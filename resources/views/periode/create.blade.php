...
@section('content')
  <!--begin::Card-->
  <form action="{{ route('periode.store') }}" class="row" method="POST">
    @csrf
    <div class="col-md-12">
      <div class="card card-custom card-stretch gutter-b">
        <div class="card-header">
          <h3 class="card-title">Tambah Periode Perencanaan</h3>
        </div>
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="w_tahun">Tahun <x-redstar /></label>
                <div class="">
                  <div class="input-group date">
                    <input type="text" name="w_tahun" value="{{ old('w_tahun') }}" class="form-control year_picker @error('w_tahun') is-invalid @enderror" readonly />
              ...
              <div class="form-group">
                <label for="w_periode">Periode <x-redstar /></label>
                <select class="form-control @error('w_periode') is-invalid @enderror" name="w_periode">
                  <option value="" hidden>- pilih periode -</option>
                  <option value="1" @if (old('w_periode') == "1") selected @endif>1</option>
                  <option value="2" @if (old('w_periode') == "2") selected @endif>2</option>
                </select>
                @error('w_periode')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              ...
              <div class="form-group">
                <label for="start">Tanggal <x-redstar /></label>
                <div class="">
                  <div class="input-daterange input-group renge_picker">
                    <input type="text" class="form-control @error('start') is-invalid @enderror" name="start" value="{{ old('start') }}" readonly />
                    <div class="input-group-append">
                      <span class="input-group-text"><i class="la la-ellipsis-h"></i></span>
                    </div>
                    <input type="text" class="form-control @error('end') is-invalid @enderror" name="end" value="{{ old('end') }}" readonly />
