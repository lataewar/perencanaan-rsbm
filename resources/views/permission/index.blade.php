  ...
  <x-subheader title="Permission">
    ...
    <div class="default-btns">
      ...
      @can('permission create')
        <x-btn.a-weight-bold-svg svg="Design/Flatten.svg" href="{{ route('permission.create') }}"
...
@section('content')
  ...
  <!--begin::Card-->
  <input type="hidden" id="urx" value="{{ route('permission.index') }}">
...
@push('js')
  ...
  <script src="{{ asset('js') }}/datatable/permission.js"></script>
